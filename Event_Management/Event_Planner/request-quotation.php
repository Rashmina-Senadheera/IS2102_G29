        ...
        <div class="form-card">
            <form>
                ...
                <div class="row">
                    ...
                    <div class="input width-50">
                        <!-- Indoor, Outdoor -->
                        <label class="input-label" id="performeIn">Performe in <span>*</span></label>
                        <input type="text" class="input-field" required />
                    </div>
                    <div class="input width-50">
                        <!-- Music, Dance, other -->
                        <label class="input-label" id="entertainmentsNeed">Need <span>*</span></label>
                        <input type="text" class="input-field" required />
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="input width-50">
                        <label class="input-label" id="transportLocations">Locations </label>
                        <input type="text" class="input-field" required />
                    </div>
                    <div class="input width-50">
                        <label class="input-label" id="hours">Hours </label>
                        <input type="text" class="input-field" required />
                    </div>
                    <div class="input width-50">
                        <label class="input-label" id="theme">Theme <span>*</span></label>
                        <input type="text" class="input-field" required />
                    </div>
                </div>
                <div class="row">
