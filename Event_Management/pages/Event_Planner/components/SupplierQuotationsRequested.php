<div class="ps-list">
    <div class='grid-main' id='rs-list'>
        <div class="cards">
            ...
            <?php
            $sql = "SELECT * FROM request_supplier_quotation WHERE status='Pending' AND EP_id='$_SESSION[user_id]' ORDER BY request_id DESC";
            ...
            ?>
                    <div class='ps-card-title' id='title'>
                        ...
                        <div class='rs-title sq'>Location</div>
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<div class='ps-card'>
                                <div class='ps-card-desc' id='rs'>
                                    <div class='rs-title t2'>#Q$r_id</div>
                                    <div class='rs-type sq'>Request for $r_title</div>
                                    <div class='rs-type sq'>#R$r_reqFor</div>
                                    <div class='rs-type sq'>$r_type</div>
                                    <div class='rs-type sq'>$r_location</div>
