...
if ($_SERVER["REQUEST_METHOD"] != "POST") {
    ...
    $customerID = checkInput($_POST['customer_id']);
    $reason = checkInput($_POST['reason']);
    $epName = $_SESSION['user_name'];
    ...
    if (empty($reason)) {
        ...
        $query = "UPDATE request_ep_quotation SET `status` = 'declined', ep_notes = '$reason' WHERE request_id = '$requestID'";
